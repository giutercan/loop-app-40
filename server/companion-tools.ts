...
export const companionToolDefinitions = [
  {
  ...
  {
    name: "updateKPI",
    description: "Update an existing KPI's target, baseline, or record a new actual value. Use when user wants to modify KPI details or log progress.",
    parameters: {
      type: "object",
      properties: {
  ...
  {
    name: "navigateToPage",
    description: "Navigate the user to a specific page in the application. Use when user asks to go somewhere or when you want to show them relevant content.",
    parameters: {
      type: "object",
      properties: {
        path: { type: "string", description: "The page path to navigate to" },
        description: { type: "string", description: "Brief description of what's on this page" }
      },
      required: ["path"]
    },
    isReadOnly: true
